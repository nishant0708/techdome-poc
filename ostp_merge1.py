    ...
    def update(self):
        while not self.stopped:
            ...
            if not cap.isOpened():
                ...
                if current_time - self.last_reconnect > self.reconnect_timeout:
...
class CrossCameraTrackingSystem:
    def __init__(self, camera_sources, common_areas=None):
        ...
        # New additions for camera streams
        self.streams = {}
        self.processed_frames = {}
        self.process_locks = defaultdict(threading.Lock)
        
        # Initialize streams
        for i, source in enumerate(camera_sources):
            self.streams[f"cam_{i}"] = CameraStream(source)
            self.streams[f"cam_{i}"].start()
    ...
    def process_camera(self, camera_id, camera_source):
        ...
        while True:
            ...
            with self.process_locks[camera_id]:
                # Resize frame
                ...
                self.processed_frames[camera_id] = (frame.copy(), timestamp)
...
def main():
    ...
    camera_sources = [
        ...
        # Or use video files
        "rtsp://admin:cctv%401212@192.168.0.141:554/ch1/sub/av_stream",
        "rtsp://admin:cctv%401212@192.168.0.221:554/ch1/sub/av_stream", #Mukul sir outside
         #mukul sir 
